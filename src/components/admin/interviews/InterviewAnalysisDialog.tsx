      ...
      <DialogContent className='sm:max-w-[650px] max-h-[80vh] overflow-y-auto'>
        ...
        <div className='space-y-6'>
          <div className='p-4 bg-blue-50 rounded-lg border border-blue-200'>
            <div className='text-sm font-semibold text-blue-900'>{t('overallPerformance')}</div>
          ...
          <div className='space-y-4'>
            ...
            <div>
              <div className='text-sm mb-1'>{t('communicationQuality')}</div>
          ...
          {analysis.strengths?.length ? (
            <div>
              <h4 className='font-semibold mb-2'>{t('keyStrengths')}</h4>
          ...
          {analysis.weaknesses?.length ? (
            <div>
              <h4 className='font-semibold mb-2'>{t('areasForImprovement')}</h4>
              <ul className='space-y-1'>
          ...
          {analysis.notable_timestamps?.length ? (
            <div>
              <h4 className='font-semibold mb-2'>{t('notableMoments')}</h4>
          ...
          {analysis.suggested_follow_up?.length ? (
            <div>
              <h4 className='font-semibold mb-2'>{t('suggestedFollowUp')}</h4>
              <ul className='space-y-1'>
          ...
          {analysis.transcript ? (
            <div>
              <h4 className='font-semibold mb-2'>{t('transcript')}</h4>
